...
function SellerByChannel() {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        const response = await axios.get(`http://localhost:8080/api/v1/product/username/${username}`);
...
export default SellerByChannel;
